...
namespace IMS.Presentation.Validators
{
    ...
    {
        private readonly List<string> validExtensions = new List<string> { "png", "jpg", "jpeg", "webp" };
        ...
        public PreSignedUrlGenValidator()
        {
            RuleFor(x => x.imageName)
                ...
                .Matches(imageNamePattern).WithMessage("Invalid Image Name. Must be between 5 and 20 characters.");
